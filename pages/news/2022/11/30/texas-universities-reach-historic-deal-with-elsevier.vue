<template>
  <div>
    ...
    <p class="mb-4 leading-relaxed">
      All TLCUA members will receive a discount on journal subscriptions&mdash;some as high as 30%&mdash;while still maintaining significant amounts of access to journals and combined, will realize a savings of over $4.75M annually. Beyond initial cost savings, Elsevier agreed to a maximum annual increase of 2% over the course of the license agreement, with some years as low as 0%, which is significantly lower than industry standard. 
    </p>
    <p class="mb-4 leading-relaxed">
    ...
    <h2 class="title-font text-3xl font-normal leading-normal mt-0 mb-2">
      About TLCUA    
    </h2>
    <p class="mb-4 leading-relaxed">
    ...
    <p class="mb-4 leading-relaxed" style="padding-left: 10px;">
    <ul>
      <li
...
export default {
  components: {},
  async fetch() {
    const data = await this.$content('landing').fetch()
